...
class MessageConnect(Message):
    def execute(self, node):
        ...
        log.info("X-max-size: %s, x: %s, y: %s" % (x_max_size, len(node.x_list), len(node.y_list)))
        ...
        if len(node.x_list) == x_max_size:
            if len(node.y_list) <= node.y_pos + 1:
                ...
                msg = MessageReconnect(node.y_list[node.y_pos + 1][0])
                node.send(self.origin_url, msg)
        else:
...
class MessageReconnect(Message):
    bind_url = None
...
class MessageGiveSnapshotResource(Message):
    ...
    def sync_y_list(self, node):
        if self.empty_list(node, node.y_list) and node.y_pos != 0:
            ...
            origin_url = node.x_list[node.x_pos - 1][0]

            msg = MessageGetYList(node.bind_url, node.x_pos)
            msg.destination_slot_id = (node.x_pos-1, node.y_pos-1, node.z_pos)
            node.send(origin_url, msg)


class MessageGetYList(Message):
    def __init__(self, bind_url, x_pos):
        self.bind_url = bind_url
        self.x_pos = x_pos

    def execute(self, node):
        log.info("MessageGetYList slot:%s x:%s y:%s x_pos %s of %s" % (node.bind_url, node.x_pos, node.y_pos, self.x_pos, len(node.x_list)))
        log.info(node.x_list)
        if self.x_pos == node.x_pos:
            log.info("Send MessageGetYList to %s" % self.bind_url)
            node.send(self.bind_url, MessageGiveNodeList('y', node.y_list))
        elif len(node.x_list[self.x_pos]) > 0:
            self.destination_slot_id = (self.x_pos, node.y_pos, node.z_pos)
            origin_url = node.x_list[self.x_pos][0]
            node.send(origin_url, self)
...
class TestOANCube(OANTestCase):
    ...
    def connect_node(self, node_id, slot_id, test_list):
        ...
        self.assertEqual(new_node.y_list, self.get_y_list(slot_id, test_list))
    ...
    def get_y_list(self, slot_id, test_list):
        x, y, z = slot_id

        new_y_list = []
        for slot_pos in xrange(x, len(test_list), 3):
...
# """
#         self.connect_node("041", (3, 3, 0), [["001", "002", "003", "004"], ["005", "006", "007", "008"], ["009", "010", "011", "012"], ["041", "___", "___", "___"],
...
#         self.connect_node("042", (3, 3, 0), [["001", "002", "003", "004"], ["005", "006", "007", "008"], ["009", "010", "011", "012"], ["041", "042", "___", "___"],
#                                              ["013", "014", "015", "016"], ["017", "018", "019", "020"], ["021", "022", "023", "024"], ["___", "___", "___", "___"],
#                                              ["025", "026", "027", "028"], ["029", "030", "031", "032"], ["033", "034", "035", "036"], ["___", "___", "___", "___"],
#                                              ["037", "038", "039", "040"], ["___", "___", "___", "___"], ["___", "___", "___", "___"], ["___", "___", "___", "___"]])

#         self.connect_node("043", (3, 3, 0), [["001", "002", "003", "004"], ["005", "006", "007", "008"], ["009", "010", "011", "012"], ["041", "042", "043", "___"],
